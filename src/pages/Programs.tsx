...
const programs = [
  {
    ...
    details: ["LEGO Education SPIKE Essential", "LEGO BricQ Motion", "Основи на механиката и конструирането", "Творчески проекти и въображение"],
    icon: Lightbulb,
    color: "bg-success",
  ...
  },
  {
    ...
    details: ["LEGO SPIKE Prime", "LEGO Education Science", "Блоково програмиране", "Сензори и мотори"],
    icon: Cpu,
    color: "bg-primary",
      ...
      <section className="py-16 bg-muted">
        <div className="container">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="max-w-4xl mx-auto rounded-2xl border-l-4 border-accent bg-accent/5 px-8 py-6"
          >
