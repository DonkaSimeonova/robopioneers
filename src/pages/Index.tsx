    ...
    <Layout>
      ...
      <section className="py-20 bg-background">
        <div className="container">
          ...
          >
            {[
              { icon: Bot, title: "LEGO Роботика Русе", desc: "Учим чрез строене и програмиране на LEGO роботи в нашата зала в Русе." },
              { icon: Brain, title: "AI и програмиране", desc: "Курсове по роботика и изкуствен интелект за деца в Русе." },
              { icon: Users, title: "Малки групи", desc: "До 8 деца в група за персонално внимание и контакт с родителите." },
              { icon: GraduationCap, title: "Опитни преподаватели", desc: "Сертифицирани инструктори с опит в STEM обучение в Русе." },
            ].map((item, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
