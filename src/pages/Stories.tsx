...
const alumniDetailed = [
  ...
  },
  {
    ...
    image: alumni2,
    text: "След 5 години в школата и редица отличия в национални състезания по роботика, Виктор учи в Математическата гимназия в Русе и се подготвя да кандидатства \u201ЕИзкуствен интелект\u201С в технически университет.",
...
const currentStudents = [
  {
    name: "Калоян, 8 г.",
    image: current1,
    text: "Калоян е в групата \u201ЕМалки изследователи\u201С. За няколко месеца сглоби първия си LEGO робот и започна да обяснява на родителите си как работят зъбните колела.",
    quote: "\u201ЕМоят робот мига, защото аз така му казах!\u201С",
  },
  {
    name: "Михаела, 10 г.",
    image: current2,
    ...
    quote: "\u201ЕНай-яко е, когато сама намеря грешката.\u201С",
  },
  {
    name: "Стефан, 13 г.",
    image: current3,
    text: "Част от състезателния отбор. Помага на по-малките и развива увереността си като млад наставник.",
    quote: "\u201ЕОбичам да обяснявам на по-малките \u2013 тогава сам разбирам по-добре.\u201С",
  },
  {
    name: "Ива, 6 г.",
    image: current4,
    text: "Ива е в най-малката група. Чрез игра и LEGO открива формите, цветовете и първите принципи на конструирането.",
    quote: "\u201ЕТова е моят влак \u2013 виж как се движи!\u201С",
  },
  {
    name: "Даниел, 13 г.",
    image: current5,
    text: "Даниел работи с 3D принтер и проектира собствени детайли за роботите на групата. Любимата му дума е \u201Епрототип\u201С.",
    quote: "\u201ЕИскам да правя неща, които още не съществуват.\u201С",
  },
];
